// ─── Единое отображение ошибок БД → HTTP для модуля «Питание» ────────────────
//
...
export function mapDbError(
  ...
  switch (error.code) {
    ...
    case '22003':                    // numeric_field_overflow (цена вне NUMERIC(12,2))
      return { status: 400, message: 'Число вне допустимого диапазона' }
    case '23503':                    // foreign_key_violation
      return { status: 400, message: 'Ссылка на несуществующую запись' }
    case '23505':                    // unique_violation (напр. дубль диет-профиля journey)
