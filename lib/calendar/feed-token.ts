 ...
 * TTL 365 дней. Отключённый аккаунт фид больше не получает (проверка в
 * /api/public/calendar-feed); отозвать одну конкретную ссылку пока нельзя
 * (нужна БД-версия токена).
 */
