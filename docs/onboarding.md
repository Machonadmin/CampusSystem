...
- **Суперадмин:** аккаунт офис-администратора — обходит проверки модулей в
  middleware. Создание суперадмина — `scripts/create-admin.ts`
  (email/пароль через переменные окружения) или миграция
