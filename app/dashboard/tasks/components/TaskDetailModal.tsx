        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 12 }}>
            <label style={{
              ...
              border: cancelSeriesMode === 'future' ? '1.5px solid #DC2626' : '1px solid var(--border)',
            }}>
              <input
                type="radio"
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--text)' }}>
                  {t('cancel_series.mode_future_label')}
                </div>
            ...
            <label style={{
              display: 'flex', gap: 8, alignItems: 'flex-start',
              padding: 10, background: 'var(--surface)', borderRadius: 6, cursor: 'pointer',
              border: cancelSeriesMode === 'all' ? '1.5px solid #DC2626' : '1px solid var(--border)',
            }}>
              <input
                type="radio"
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--text)' }}>
                  {t('cancel_series.mode_all_label')}
                </div>
                <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 2 }}>
