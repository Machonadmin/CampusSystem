...
import PsychologistStudentClient from './PsychologistStudentClient'

/**
 * Карта сопровождения студента: панель профиля (правка), история консультаций,
