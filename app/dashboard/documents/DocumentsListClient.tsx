    ...
    <div className="p-6 space-y-5">
      ...
      {(expired.length > 0 || expiringSoon.length > 0) && (
        <div style={{ background: '#fff', border: '1px solid #E5E7EB', borderRadius: 12, padding: 16 }}>
          <h2 style={{ fontSize: 15, fontWeight: 600, color: '#111827', margin: '0 0 12px' }}>{t('expiring.title')}</h2>
                  ...
                  >
                    ...
                    <td style={td}>
                      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
                        {s.doc_count > 0 && (
                          <span style={{ fontSize: 11, fontWeight: 600, padding: '2px 9px', borderRadius: 999, background: light, color: '#4B5563' }}>
      ...
      {canManage && (
        <div style={{ fontSize: 11, color: '#9CA3AF' }}>{t('list.manage_hint')}</div>
      )}
    </div>
  )
}
