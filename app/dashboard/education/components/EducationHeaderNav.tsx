...
export default function EducationHeaderNav() {
  ...
  // «היום שלי» убран: его функция (мои уроки + отметка посещаемости) теперь
  // живёт в самом Календаре — урок кликается и посещаемость ставится оттуда
  // (запрос владельца: «למה גם פה וגם שם»). Осталась только «מערכת שעות».
  const daily: NavLink[] = [
