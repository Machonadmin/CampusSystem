...
type Sub = 'subjects' | 'specialties' | 'study_groups' | 'class_groups' | 'buildings' | 'year_rollover'
...
const ICON: Record<string, string> = {
  ...
  structure: 'M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.75A.75.75 0 019.75 16.5h4.5a.75.75 0 01.75.75V21',
  units: 'M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 8.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z',
...
export default function StudiesSettings() {
  ...
  const links: { icon: string; label: string; href: string }[] = [
    // «מבנה יחידות» и «יחידות לימוד» перенесены сюда из «פעולות» (owner:
    // панель действий = только ежедневная работа; конфигурация — здесь).
    { icon: ICON.structure, label: t('dashboard.launch_structure'), href: '/dashboard/education/structure' },
    { icon: ICON.units, label: t('dashboard.launch_units'), href: '/dashboard/education/units' },
