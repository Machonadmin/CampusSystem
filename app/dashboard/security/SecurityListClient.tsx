          ...
          {items.map(r => {
            ...
            return (
              <div
                ...
                style={{
                  background: prominent ? '#FEF2F2' : '#fff',
                ...
                onMouseLeave={e => { (e.currentTarget as HTMLDivElement).style.borderColor = '#E5E7EB'; (e.currentTarget as HTMLDivElement).style.borderInlineStartColor = vc.fg }}
              >
